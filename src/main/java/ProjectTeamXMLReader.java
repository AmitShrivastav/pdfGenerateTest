...
public class ProjectTeamXMLReader extends AbstractObjectReader {
    ...
    protected void generateFor(ProjectTeam projectTeam) throws SAXException {
        ...
        handler.element("date", projectTeam.getDate());
        handler.element("prod", projectTeam.getProd());
    ...
    protected void generateFor(ProjectMember projectMember) throws SAXException {
        ...
        handler.element("qty",projectMember.getQty());
        handler.element("bin",projectMember.getBin());
        handler.element("location",projectMember.getLocation());
        handler.element("scanCode",projectMember.getScanCode());
        handler.element("trace",projectMember.getTrace());
